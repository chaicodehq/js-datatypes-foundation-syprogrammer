...
export function createPaanOrder(basePaan, customizations) {
  ...
  if (customizations == null || typeof customizations != 'object') return structuredClone(basePaan)
...
export function updatePrices(menu, increase) {
  // Your code here
  if (typeof menu != 'object' || menu == null || isNaN(increase)) return {}
  let increased = Object.entries(menu).map((item) => [item[0], item[1] + increase])
